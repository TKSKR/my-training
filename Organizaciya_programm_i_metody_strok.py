...
from Organizaciya_programm_i_metody_strok import surname
...
# surname_name = {"Коротков": "Сергей","Короткова": "Светлана","Коротков": "Даниил", "Коротков": "Кирилл"}
# surname = input("Введите фамилию: ")
# surname = surname.lower()
# while True:
#     if surname in employee_name:
#         input(print(f"Ваше имя: {employee_name[surname]}?"))
#     else:
